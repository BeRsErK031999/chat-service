const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      'Shortcut help opens from the compact ActivityPanel ? button or ? key, is discoverable without visual clutter, and closes with Escape',
      'Shortcut help lists activity arrows, Enter, Escape, room switching, workflow activity cycling, Ctrl/Cmd+K, and / search focus',
      ...
      'After shortcut help closes, ActivityPanel traversal, composer focus, and search focus still work without a focus trap',
